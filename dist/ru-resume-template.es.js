import { openBlock as a, createElementBlock as n, createElementVNode as e, renderSlot as $, createTextVNode as v, toDisplayString as U, createCommentVNode as w, pushScopeId as k, popScopeId as T, toRefs as j, unref as l, Fragment as h, renderList as m, withDirectives as s, vModelText as o, createVNode as b, withCtx as c } from "vue";
const B = (p, y) => {
      ...
      e("div", q, [
        ...
        e("div", H, [
          ...
          e("div", {
            ...
            d.disabled ? w("v-if", !0) : (a(), n("svg", R, z))
          ])
        ])
      ]),
      e("div", K, [
...
}, V = /* @__PURE__ */ B(D, [["__scopeId", "data-v-a7b24004"]]), f = (p) => (k("data-v-da2d3371"), p = p(), T(), p), P = {
  id: "ru-page",
  style: { "background-color": "rgb(207, 207, 207)" }
}, X = { id: "ru-left" }, F = { id: "ru-avatar" }, L = ["src"], G = { class: "ru-left-kw-box" }, J = {
  key: 0,
  class: "ru-left-key"
}, Q = ["onUpdate:modelValue"], W = { class: "ru-left-word" }, Y = ["onUpdate:modelValue", "disabled"], I = { id: "ru-right" }, ee = { class: "ru-personage" }, te = /* @__PURE__ */ f(() => /* @__PURE__ */ e(
  "div",
  { class: "ru-personage-title" },
  "个人简历",
  -1
  /* HOISTED */
)), de = { class: "ru-personage-kws" }, le = ["disabled", "onUpdate:modelValue"], ie = ["onUpdate:modelValue", "disabled"], se = /* @__PURE__ */ f(() => /* @__PURE__ */ e(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
  ...
  -1
  /* HOISTED */
)), oe = { style: { display: "flex", "justify-content": "space-between", "margin-top": "1rem" } }, ae = { style: { display: "flex" } }, ne = ["onUpdate:modelValue", "disabled"], re = ["onUpdate:modelValue", "disabled"], pe = ["onUpdate:modelValue", "disabled"], ue = ["onUpdate:modelValue", "disabled"], ce = { style: { transform: "translateX(0.2rem)" } }, _e = { style: { display: "flex" } }, he = /* @__PURE__ */ f(() => /* @__PURE__ */ e(
  "div",
  { style: { width: "20%" } },
  "专业成绩：",
  -1
  /* HOISTED */
)), me = ["onUpdate:modelValue", "disabled"], ye = { style: { display: "flex" } }, Ce = /* @__PURE__ */ f(() => /* @__PURE__ */ e(
  "div",
  { style: { width: "20%" } },
  "主修课程：",
  -1
  /* HOISTED */
)), be = ["onUpdate:modelValue", "disabled"], ve = /* @__PURE__ */ f(() => /* @__PURE__ */ e(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    "xmlns:xlink": "http://www.w3.org/1999/xlink",
  ...
  -1
  /* HOISTED */
)), xe = { style: { display: "flex", "justify-content": "space-between", "margin-top": "1rem" } }, fe = { style: { display: "flex" } }, we = ["onUpdate:modelValue", "disabled"], ge = ["onUpdate:modelValue", "disabled"], Ue = ["onUpdate:modelValue", "disabled"], Ve = ["onUpdate:modelValue", "disabled"], $e = ["onUpdate:modelValue", "disabled"], ke = /* @__PURE__ */ f(() => /* @__PURE__ */ e(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    "xmlns:xlink": "http://www.w3.org/1999/xlink",
  ...
  -1
  /* HOISTED */
)), Te = ["onUpdate:modelValue", "disabled"], Be = ["onUpdate:modelValue", "disabled"], Me = ["onUpdate:modelValue", "disabled"], Ze = /* @__PURE__ */ f(() => /* @__PURE__ */ e(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    "xmlns:xlink": "http://www.w3.org/1999/xlink",
  ...
  -1
  /* HOISTED */
)), Ae = ["disabled"], je = /* @__PURE__ */ Object.assign({
        ...
        e("div", G, [
          (a(!0), n(
            ...
            m(l(d).baseKw, (t, i) => (a(), n("div", {
              ...
              l(d).disabled ? w("v-if", !0) : s((a(), n("input", {
                key: 1,
                type: "text",
        ...
        b(V, {
          ...
          context: c(() => [
            (a(!0), n(
              h,
              null,
              m(l(d).educationalBackground, (t) => (a(), n("div", null, [
                e("div", oe, [
                  e("div", ae, [
                    s(e("input", {
                      type: "text",
        ...
        b(V, {
          ...
          context: c(() => [
            (a(!0), n(
              h,
              null,
              m(l(d).workExperience, (t) => (a(), n("div", null, [
                e("div", xe, [
                  e("div", fe, [
                    s(e("input", {
                      type: "text",
...
\r
        ...
        b(V, {
          ...
          context: c(() => [
            (a(!0), n(
              h,
              null,
              m(l(d).certificateOfHonor, (t, i) => (a(), n("div", {
                style: { display: "flex" },
                key: i
              }, [
                s(e("input", {
...
}), Z = /* @__PURE__ */ B(je, [["__scopeId", "data-v-da2d3371"]]), Ee = { style: { display: "flex", "align-items": "center", "justify-content": "space-between" } }, Oe = { style: { "font-size": "2rem", "border-bottom": "solid 4px #068359" } }, qe = /* @__PURE__ */ e(
  "path",
  {
...
}, M = (p) => (k("data-v-6634ef0d"), p = p(), T(), p), Se = { style: { display: "flex", width: "100%", "background-color": "#ffffff", "flex-direction": "column", "align-items": "center", position: "relative" } }, ze = /* @__PURE__ */ M(() => /* @__PURE__ */ e(
  "div",
  ...
  -1
  /* HOISTED */
)), Ke = { style: { width: "95%", margin: "1rem 0", display: "flex" } }, De = { style: { width: "80%", "padding-right": "2rem" } }, Pe = { class: "ru-personage-kws" }, Xe = ["disabled", "onUpdate:modelValue"], Fe = ["onUpdate:modelValue", "disabled"], Le = ["disabled", "onUpdate:modelValue"], Ge = ["onUpdate:modelValue", "disabled"], Je = { style: { width: "20%" } }, Qe = ["src"], We = { style: { width: "95%", margin: "1rem 0", display: "flex" } }, Ye = { style: { width: "100%" } }, Ie = { style: { display: "flex", "justify-content": "space-between", "margin-top": "1rem" } }, e3 = { style: { display: "flex" } }, t3 = ["onUpdate:modelValue", "disabled"], d3 = ["onUpdate:modelValue", "disabled"], l3 = ["onUpdate:modelValue", "disabled"], i3 = ["onUpdate:modelValue", "disabled"], s3 = { style: { transform: "translateX(0.2rem)" } }, o3 = { style: { display: "flex" } }, a3 = /* @__PURE__ */ M(() => /* @__PURE__ */ e(
  "div",
  { style: { width: "10%" } },
  "专业成绩：",
  -1
  /* HOISTED */
)), n3 = ["onUpdate:modelValue", "disabled"], r3 = { style: { display: "flex" } }, p3 = /* @__PURE__ */ M(() => /* @__PURE__ */ e(
  "div",
  { style: { width: "10%" } },
  "主修课程：",
  -1
  /* HOISTED */
)), u3 = ["onUpdate:modelValue", "disabled"], c3 = { style: { width: "95%", margin: "1rem 0", display: "flex" } }, _3 = { style: { width: "100%" } }, h3 = { style: { display: "flex", "justify-content": "space-between", "margin-top": "1rem" } }, m3 = { style: { display: "flex" } }, y3 = ["onUpdate:modelValue", "disabled"], C3 = ["onUpdate:modelValue", "disabled"], b3 = ["onUpdate:modelValue", "disabled"], v3 = ["onUpdate:modelValue", "disabled"], x3 = ["onUpdate:modelValue", "disabled"], f3 = { style: { width: "95%", margin: "1rem 0", display: "flex" } }, w3 = { style: { width: "100%" } }, g3 = ["onUpdate:modelValue", "disabled"], U3 = ["onUpdate:modelValue", "disabled"], V3 = ["onUpdate:modelValue", "disabled"], $3 = { style: { width: "95%", margin: "1rem 0", display: "flex" } }, k3 = { style: { width: "100%" } }, T3 = ["disabled"], B3 = /* @__PURE__ */ Object.assign({
